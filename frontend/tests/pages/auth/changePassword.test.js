...
describe("sugnup page tests", () => {
  test("should dispatch an error action", () => {
    ...
    render(
      <Provider store={store}>
        <ResetPassword withError={"fake error"} />
      </Provider>
    );
  ...
  test("should handle validition (first password invalid)", () => {
    const store = mockStore({});
    render(
      <Provider store={store}>
        <ResetPassword token={"token"} />
  ...
  test("should handle validition (second password invalid)", () => {
    const store = mockStore({});
    render(
      <Provider store={store}>
        <ResetPassword token={"token"} />
  ...
  test("should handle form submition failed", async () => {
    const store = mockStore({});
    render(
      <Provider store={store}>
        <ResetPassword token={"token"} />
  ...
  test("should handle form submition succeed", async () => {
    const store = mockStore({});
    render(
      <Provider store={store}>
        <ResetPassword token={"token"} />
