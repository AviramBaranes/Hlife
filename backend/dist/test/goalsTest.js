...
describe('get goals tests', () => {
    ...
    it('send success response if no model was found', async () => {
        ...
        await goalsController.getGoals(req, res, () => { });
        (0, chai_1.expect)(res.statusCode).equal(201);
        (0, chai_1.expect)(res.jsonObj.basicGoal).equal('basicGoal');
        (0, chai_1.expect)(res.jsonObj.detailGoals).equal('detailGoals');
    });
    afterEach(() => {
        stubedGoalsModel.restore();
    });
